...
preferences {
	section("Select actuators to summarize:") {
		input name: "devs1", type: "capability.actuator", multiple: true, required: false
	}
    
	section("Select sensors to summarize:") {
		input name: "devs2", type: "capability.sensor", multiple: true, required: false
	}
    
    section("Select summary device:") {
    	input name: "sumDev", type: "capability.switch", required: true
    }
    
    section("Select attribute to monitor:") {
    	input name: "monAtt", type: "text", required: true
    }
    
    section("Select desired value of attribute:") {
    	input name: "desVal", type: "text", required: true
    }
}
